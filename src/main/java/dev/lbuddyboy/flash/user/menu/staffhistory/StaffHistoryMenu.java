...
public class StaffHistoryMenu extends PagedMenu<Punishment> {

    public UUID target;
    public PunishmentType type;

    public StaffHistoryMenu(UUID target, PunishmentType type) {
        this.target = target;
        this.type = type;
        this.objects = Flash.getInstance().getUserHandler().tryUser(this.target, true).getStaffInfo().getSortedPunishmentsByType(type);
    }
